...
const Landing = () => {
	...
	const handleDashboard = () => {
		if (address === "0x807ed9A362411A5ba06dd8Fea8C69b717C696145") {
	...
	return (
		<Fragment>
				...
				<div className="max-w-screen-xl py-3 mx-auto flex justify-between items-center">
					<div className="flex gap-20 items-center text-white">
						...
						<ul className="flex text-base gap-12">
							...
							<li>
								<NavLink to="/view" className="underline font-bold">
									View Documents
								</NavLink>
							</li>
						</ul>
			...
			<section className="bg-b2 pt-20" id="product">
				<div className="max-w-screen-xl mx-auto py-24 flex gap-12">
					<div className="flex-1 text-white">
						...
						<p className="my-8">
							A specialized verification tool offering a Seamless, Secure, and
							Efficient solution for individuals and businesses
						</p>
						<p
							className="text-xl cursor-pointer font-bold hover:text-blue-500 transition"
						...
						<div className="search flex items-center my-8 px-4 bg-white rounded-full w-[493px] h-[68px]">
							<input
								className="flex-1 outline-none text-b1 px-2 bg-transparent"
								type="text"
								placeholder="Go to view document as a guest"
								value={input}
								onChange={(e) => setInput(e.target.value)}
							/>
							<button
								className="bg-b1 px-3 py-2 rounded-3xl"
								type="button"
						...
						<ul className="flex gap-6">
							<li className="flex items-center gap-2">
								<CheckIcon sx={{ color: pink[500] }} /> Free trial
							</li>
							<li className="flex items-center gap-2">
								<CheckIcon sx={{ color: pink[500] }} /> No credit card required
							</li>
						</ul>
					</div>
					<div className="flex-1">
						<div className="w-[537px] h-[433px] ml-auto relative">
							...
							<img
								className="absolute w-[719px] h-[632px] object-cover top-0 -z-10 -left-1/4"
								src={ImageHeader2}
								alt=""
							/>
						</div>
			...
			<section className="h-[257px] bg-b1 flex items-center justify-center">
				<ul className="flex text-white w-3/4">
					<li className="flex-1 px-6 py-2 border-r-2 border-indigo-500">
					...
					<div className="py-12 flex items-center justify-center">
						<ul className="flex gap-12">
							<li className="text-white text-center">
								<div>
									<RestoreIcon sx={{ color: pink[500], fontSize: 50 }} />
								</div>
								<p className="font-bold text-lg my-2">Realtime update</p>
								<p className="text-gray-medium">
									Get your verified state in <br /> real time
								</p>
							</li>
							<li className="text-white text-center">
								<div>
								...
								<p className="text-gray-medium">
									Upload your <br /> documentations privately
								</p>
							</li>
							<li className="text-white text-center">
								<div>
							...
							<li className="text-white text-center">
								<div>
									<MemoryOutlinedIcon sx={{ color: pink[500], fontSize: 50 }} />
								</div>
								<p className="font-bold text-lg my-2">Easy and Intuitive</p>
								<p className="text-gray-medium">
									Easy to use and <br /> everyone can use it
								</p>
							</li>
						</ul>
					</div>
			...
			<section className="bg-b2">
				<div className="container max-w-screen-xl pt-24 m-auto flex gap-4">
					<div className="flex-1">
						<h2 className="text-white font-semibold text-4xl leading-normal">
							Upload your documentations <br />
						...
						<ul>
							<li className="flex items-center gap-2 text-white text-sm mb-2">
								<CheckIcon sx={{ color: pink[500] }} /> Upload documentations
							</li>
							<li className="flex items-center gap-2 text-white text-sm mb-2">
								<CheckIcon sx={{ color: pink[500] }} /> Organize your
								documentations
							</li>
							<li className="flex items-center gap-2 text-white text-sm mb-2">
								<CheckIcon sx={{ color: pink[500] }} /> Organize your
					...
					<div className="flex-1">
						<div className="w-[540px] h-[371px] ml-auto relative">
							...
							<img
								className="absolute scale-125 -top-1/4 left-0 -z-10"
								src={LayerBluer}
								alt=""
							/>
						</div>
			...
			<section className="bg-b2">
				<div className="container max-w-screen-xl pt-24 m-auto flex gap-4">
					...
					<div className="flex-1">
						<h2 className="text-white font-semibold text-4xl leading-normal">
							We use Blockchain to securely <br />
							verify your documentations and <br />
							track all others
						</h2>
						<p className="text-gray-medium my-6">
							Easy to managed documentations, staffs will contact your for{" "}
							<br />
							needed information
						</p>
						<ul>
							<li className="flex items-center gap-2 text-white text-sm mb-2">
								<CheckIcon sx={{ color: pink[500] }} /> Secure
							</li>
							<li className="flex items-center gap-2 text-white text-sm mb-2">
								<CheckIcon sx={{ color: pink[500] }} /> Anonymous
							</li>
						</ul>
					</div>
				</div>
			</section>
			<section className="bg-b2" id="pricing">
				<div className="container max-w-screen-xl pt-24 m-auto">
					<h2 className="text-white text-center font-bold text-4xl">
					...
					<div className="my-12 flex gap-24 items-center justify-center text-black">
						<div className="w-[400px] rounded-lg py-12 bg-white  shadow-custom">
							...
							<div className="flex items-center justify-center">
								<span className="font-bold text-4xl mr-3 relative">
									...
									15
									<span className="font-medium text-lg relative -top-1">
										/month
									</span>
								</span>
							...
							<div className="text-center my-3 text-blue-600 font-bold text-sm">
								20% saved
							</div>
							<div className="h-[1px] w-[80%] bg-b2 m-auto my-8"></div>
							<h5 className="w-[60%] text-left m-auto mb-4 text-xl font-semibold">
								This plan includes:
							</h5>
							<ul className="w-[60%] m-auto">
								<li className="flex items-center gap-2 text-base font-semibold mb-2">
									<CheckIcon sx={{ color: pink[500] }} /> 5 GB storage
								</li>
								<li className="flex items-center gap-2 text-base font-semibold mb-2">
									<CheckIcon sx={{ color: pink[500] }} /> 50,000 requests per
									month
								</li>
								<li className="flex items-center gap-2 text-base font-semibold mb-2">
									<CheckIcon sx={{ color: pink[500] }} /> Automatic Verification
								</li>
								<li className="flex items-start gap-2 text-base font-semibold mb-2">
									<CheckIcon sx={{ color: pink[500] }} /> Guest sign-in without
									account
								</li>
								<li className="flex items-start gap-2 text-base font-semibold mb-2">
									<CheckIcon sx={{ color: pink[500] }} /> Support for various
									languages
									<br /> (English, Vietnamese, Japanese, Korean)
								</li>
							</ul>
							<div className="px-8 mt-12">
								<button className="w-full bg-pink py-2 text-white font-semibold rounded-lg">
									Get Started
								</button>
							</div>
						</div>
						<div className="w-[400px] rounded-lg py-12 bg-white shadow-custom">
							...
							<div className="text-center my-3 text-red-600 font-bold text-sm">
								10% saved
							</div>
							<div className="h-[1px] w-[80%] bg-b2 m-auto my-8"></div>
							<h5 className="w-[60%] text-left m-auto mb-4 text-xl font-semibold">
							...
							<ul className="w-[65%] m-auto">
								<li className="flex items-center gap-2 text-base font-semibold mb-2">
									<CheckIcon sx={{ color: pink[500] }} /> 15 GB storage
								</li>
								<li className="flex items-center gap-2 text-base font-semibold mb-2">
									<CheckIcon sx={{ color: pink[500] }} /> 100,000 requests per
									month
								</li>
								<li className="flex items-center gap-2 text-base font-semibold mb-2">
					...
					<div className="text-center text-white">
						No credit card required, start for free, pick a plan later. Cancel
						at any time
					</div>
				</div>
			</section>
			<section className="bg-b2 pb-12">
				<div className="container max-w-screen-xl pt-24 m-auto">
					...
					<div className="w-3/4 m-auto text-white text-lg">
						How can I upload my documentations?
					</div>
					<div className="h-[1px] w-3/4 bg-pink m-auto my-12"></div>
					<div className="w-3/4 m-auto text-white text-lg">
						Where and when I could get the verified state of my documentations?
					</div>
					<div className="h-[1px] w-3/4 bg-pink m-auto my-12"></div>
					<div className="w-3/4 m-auto text-white text-lg">
						Who will verify my documentations
					</div>
					<div className="h-[1px] w-3/4 bg-pink m-auto my-12"></div>
			...
			<section className="bg-b1 py-36">
				<div className="container max-w-screen-xl mt-24 m-auto">
					<h2 className="text-white text-center font-bold text-4xl mb-12">
						Get started with our platform <br />
						now and supercharge your <br />
						productivity.
					</h2>
					<div className="flex items-center justify-center gap-12">
						<button className="w-fit px-4 py-2 text-white bg-pink rounded-full">
							Get Started
						</button>
			...
			<section className="bg-b2" id="about">
				<div className="container max-w-screen-xl py-24 m-auto">
					...
					<div className="flex flex-wrap gap-4 items-center justify-center">
						...
						<div className="w-[350px] h-[500px] relative rounded-2xl overflow-hidden">
							...
							<div className="absolute z-10 bottom-0 left-0 px-12 pb-6 w-full">
								<p className="font-semibold text-2xl text-white">Bùi Hải</p>
