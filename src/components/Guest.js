        ...
        <div className="w-full bg-black rounded p-4">
          ...
          {flag ?
            ...
            <form action="" onSubmit={handleSubmit}>
              <input type="text" placeholder="Input your public key to view" className="w-full outline-none p-2 my-4 text-white rounded-lg" value={input} onChange={(e) => setInput(e.target.value)} />
